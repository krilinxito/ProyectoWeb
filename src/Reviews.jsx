...
const reviewsList = [
    ...
    { title: "The Substance", path: "/reviews/the-substance", poster: "substance.webp", synopsis: "The Substance explores the boundaries of human curiosity and fear, delivering a gripping narrative that challenges our understanding of the unknown.", cardStyle: { background: 'linear-gradient(to right, #6A0572, #1E1E2C)', borderRadius: '10px' } },
    { title: "Terrifier 3", path: "/reviews/terrifier-3", poster: "terrifier3.jpg", synopsis: "Terrifier 3 continues the gruesome tale of Art the Clown with shocking horror and unrelenting suspense that will haunt your dreams.", cardStyle: { background: 'linear-gradient(to right, #3D0000, #8B0000)', borderRadius: '10px' } },
    { title: "The Wild Robot", path: "/reviews/the-wild-robot", poster: "wildrobot.jpg", synopsis: "The Wild Robot is a heartwarming tale of survival, adaptation, and the beauty of nature through the eyes of a robot stranded on an island.", cardStyle: { background: 'linear-gradient(to right, #3BB143, #1E5631)', borderRadius: '10px' } }
  ];
